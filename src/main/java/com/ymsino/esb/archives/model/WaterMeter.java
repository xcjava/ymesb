...
public class WaterMeter  implements java.io.Serializable {
    ...
    /** full constructor */
    public WaterMeter(String hardwareId, String waterCustomerId, Long uid, String userId, String userName, String chargingUnitId, String parentUnits, String nature, String purcAmount, String showWarn, String closeWarn, String childHardwareId, String dataType, Integer constant, String concHardwareId, Integer wmSn, Float initialYards, Long price, String alarmVolume, String radioFrequency, Short type, Long createTimestamp) {
        this.hardwareId = hardwareId;
