 ...
 * 			
    ...
    /** full constructor */
    public TestMeterCodeData(String concHardwareId, String meterHardwareId, Float meterReading, Float batteryVoltage, String valveStatus, String dataType, String magneticAttack, String errorStatus, String replyStatus, Long createTimestamp, Long realTimestamp, String userId, String waterCustomerId, String chargingUnitId, String parentUnits) {
