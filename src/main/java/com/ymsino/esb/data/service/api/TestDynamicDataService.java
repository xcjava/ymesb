...
public interface TestDynamicDataService {
	 ...
	 * @return
	 */
	@WSDLDocumentation("根据id获取召测本机动态数据")
	public TestDynamicDataReturn getById(@WebParam(name="id")Long id);
	 ...
	 * @return
	 */
	@WSDLDocumentation("根据查询参数获取召测本机动态数据分页列表")
	public List<TestDynamicDataReturn> getListpager(
	 ...
	 * @return
	 */
	@WSDLDocumentation("根据查询参数获取召测本机动态数据总记录数")
