...
public interface WaterMonthUsageAmountService {
	 ...
	 * @return
	 */
	@WSDLDocumentation("根据id获取水表月用量")
	public WaterMonthUsageAmountReturn getById(@WebParam(name="id")Long id);
	 ...
	 * @return
	 */
	@WSDLDocumentation("根据查询参数获取水表月用量分页列表")
	 ...
	 * @return
	 */
	@WSDLDocumentation("根据查询参数获取水表月用量总记录数")
