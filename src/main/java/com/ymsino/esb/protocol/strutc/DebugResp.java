 ...
 */
public class DebugResp extends AbstractMessage {
	 ...
	 * 78 78
	 */
	private final String[] dataSn = {"78", "78"};
	 ...
	 * BCD
	 */
	public String[] dataContent = new String[1];
	...
	public DebugResp(byte[] bytes){
		...
		this.dataContent[0] = DataConverter.bytesToHexString(ByteTool.subByte(bytes, offset, 1));
