 ...
 */
public class TestDataResp extends AbstractMessage {
	 ...
	 * 12 00
	 */
	private final String[] dataLength = {"00", "12"};
	 ...
	 * BCD
	 */
	public String[] dataDate = new String[4];
	...
	public TestDataResp(byte[] bytes){
		int offset = 0;
		...
		this.dataDate[0] = DataConverter.bytesToHexString(ByteTool.subByte(temp, 3, 1));
		this.dataDate[1] = DataConverter.bytesToHexString(ByteTool.subByte(temp, 2, 1));
		this.dataDate[2] = DataConverter.bytesToHexString(ByteTool.subByte(temp, 1, 1));
		this.dataDate[3] = DataConverter.bytesToHexString(ByteTool.subByte(temp, 0, 1));
	...
	protected String getString() {
		...
		str += getNioFieldString(this.dataDate) + "|";
	...
	public void init() {
		...
		System.arraycopy(ByteTool.reverse(DataConverter.hexStringToByte(getFieldString(this.dataDate))), 0, this.bytes, offset, this.dataDate.length);
		offset += this.dataDate.length;
